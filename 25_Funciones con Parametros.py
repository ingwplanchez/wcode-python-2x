...
def str_main():
    ...
    int_Numero1 = int(raw_input('Introduce El primer numero: '))
    int_Numero2 = int(raw_input('Introduce El Segundo numero: '))
    ...
    # Variable local
    str_Continuar = raw_input(('Desea Continuar: S/N:'))
...
##    print(str_menu.__doc__)
    ...
    # Variable Local
    str_Operacion = raw_input('Teclea la opcion y pulsa Enter: ')
